...
(function($){
  ...
  $.fn.greyScale = function(args) {
    ...
    function greyScale(image, width, height, style) {
      can = $('<canvas/>')
        .attr({
          'style': style,
          'width': width,
        ...
        if (window.location.hostname !== this.src.split('/')[2]) {
         ...
         $.getImageData({
            ...
            success: $.proxy(function(image) {
                can = greyScale(image, image.width, image.height, image.style);
          ...
          can = greyScale($(this)[0], $(this).width(), $(this).height(), $(this).attr("style"));
