...
Select Case task
	...
	%><!--#include file="page/img_upload.asp"--><%

	Case GlobalConfig("General_Page") & "_file_upload"

	%><!--#include file="page/file_upload.asp"--><%

	Case GlobalConfig("General_Page") & "_settings"

	%><!--#include file="page/logo_upload.asp"--><%
	...
	%><!--#include file="category/img_upload.asp"--><%

	Case GlobalConfig("General_Categories") & "_file_upload"

	%><!--#include file="category/file_upload.asp"--><%

	Case GlobalConfig("General_Categories") & "_settings"

	%><!--#include file="category/logo_upload.asp"--><%



	Case GlobalConfig("General_Products")

	%><!--#include file="product/img_upload.asp"--><%

	Case GlobalConfig("General_Products") & "_file_upload"

	%><!--#include file="product/file_upload.asp"--><%

	Case GlobalConfig("General_Products") & "_settings"

	%><!--#include file="product/logo_upload.asp"--><%



	Case GlobalConfig("General_Banner")

	%><!--#include file="banner/img_upload.asp"--><%

	Case GlobalConfig("General_Banner") & "_settings"

	%><!--#include file="banner/logo_upload.asp"--><%



	Case "ayar"

	%><!--#include file="config/logo_upload.asp"--><%
