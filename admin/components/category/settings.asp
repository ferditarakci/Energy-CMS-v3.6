...
<body>
<%
Set objRs = setExecute("SELECT * FROM #___settings WHERE opt_status = 1 And parent = "& GlobalConfig("General_CategoriesPN") &";")
	If Not objRs.Eof Then
		...
		GlobalConfig("LogoWrite") = "" ' "<img src=""" & sFolder("", -1) & "/" & objRs("LogoWrite") & """ />"
		...
		If objRs("LogoWrite") <> "" Then
			...
			GlobalConfig("LogoWrite") = GlobalConfig("LogoWrite") & "<img src=""" & kFolder("", -1) & "/" & objRs("LogoWrite") & """ />"
	...
	<div style="margin-right:0;" class="maincolumn-body">
		<div class="m_box">
			...
			<div class="head clearfix">
				<div class="form-table clearfix" style="padding-left:20px; padding-top:20px;">
<%
'i = 1
'While Not objRs.Eof
...
<div class="clearfix">
	...
	<div class="boxs clearfix" style="width:710px;">
...
SQL = SQL & "LEFT JOIN #___settings_lang As b ON a.lng = b.lang And b.parent = "& GlobalConfig("General_CategoriesPN") &"" & vbCrLf
...
<input name="parent" type="hidden" value="<%=GlobalConfig("General_CategoriesPN")%>" />
