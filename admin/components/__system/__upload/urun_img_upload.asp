...
If FilesKontrol(pFolder("", -1) & "/" & GlobalConfig("LogoWrite")) Then
	GlobalConfig("LogoWrite") = Server.MapPath(pFolder("", -1)) & "/" & GlobalConfig("LogoWrite")
	intDurum = True
End If
...
imgPath = Server.MapPath(pFolder(post_id, 0))
imgPath2 = Server.MapPath(pFolder(post_id, 1))
imgPath3 = Server.MapPath(pFolder(post_id, 2))
