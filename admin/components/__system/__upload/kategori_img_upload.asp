...
If FilesKontrol(kFolder("", -1) & "/" & GlobalConfig("LogoWrite")) Then
	GlobalConfig("LogoWrite") = Server.MapPath(kFolder("", -1)) & "/" & GlobalConfig("LogoWrite")
	intDurum = True
End If
...
imgPath = Server.MapPath(kFolder(post_id, 0))
imgPath2 = Server.MapPath(kFolder(post_id, 1))
imgPath3 = Server.MapPath(kFolder(post_id, 2))
