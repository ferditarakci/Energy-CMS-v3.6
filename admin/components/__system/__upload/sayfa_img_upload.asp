...
If FilesKontrol(sFolder("", -1) & "/" & GlobalConfig("LogoWrite")) Then
	GlobalConfig("LogoWrite") = Server.MapPath(sFolder("", -1)) & "/" & GlobalConfig("LogoWrite")
	intDurum = True
End If
...
imgPath = Server.MapPath(sFolder(post_id, 0))
imgPath2 = Server.MapPath(sFolder(post_id, 1))
imgPath3 = Server.MapPath(sFolder(post_id, 2))
