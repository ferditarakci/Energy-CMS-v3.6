...
Else
	...
	Response.Write("			<th style=""width:41% !important"">Başlık</th>" & vbcrlf) ' onclick=""return listItemTask('all', 'sirala', '')""
	...
	'Response.Write("			<th colspan=""3"" style=""width:11% !important"">İşlemler</th>" & vbcrlf) 
	Response.Write("		</tr>" & vbcrlf) 
	Response.Write("	</thead>" & vbcrlf) 
