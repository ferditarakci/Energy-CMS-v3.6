<%
Private Sub EbeveynSayfa(ByVal intAnaid, ByVal intLevel, ByVal intEbeveyn)
	Dim sSQL, objSubRs, y, tempSpaces, strSelected, strDisabled
	sSQL = ""
	sSQL = sSQL & "SELECT t1.id, t2.title FROM #___sayfa t1 "
	...
	Set objSubRs = setExecute( sSQL )
		...
		Do While Not objSubRs.Eof
			...
			If (id <> objSubRs("id")) Then	Call EbeveynSayfa(Cdbl(objSubRs("id")), intLevel +1, intEbeveyn)
