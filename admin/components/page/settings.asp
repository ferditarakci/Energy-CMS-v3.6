...
<%
Set objRs = setExecute("SELECT * FROM #___settings WHERE opt_status = 1 And parent = "& GlobalConfig("General_PagePN") &";")
	If Not objRs.Eof Then
		...
		If objRs("LogoWrite") <> "" Then
			...
			GlobalConfig("LogoWrite") = GlobalConfig("LogoWrite") & "<img src=""" & sFolder("", -1) & "/" & objRs("LogoWrite") & """ />"
...
SQL = SQL & "LEFT JOIN #___settings_lang As b ON a.lng = b.lang And b.parent = "& GlobalConfig("General_PagePN") &"" & vbCrLf
...
<input name="parent" type="hidden" value="<%=GlobalConfig("General_PagePN")%>" />
