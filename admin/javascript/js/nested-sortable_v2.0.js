...
(function($) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		_mouseDrag: function(event) {
			...
			$(newList).addClass("sublist clearfix");
			...
			$(items).each(function() {
				...
				if (res) {
					...
					*/
					...
					// Revizyon Tarihi - 15/06/2012
					str.push(
						(o.key || res[1]) + "[]" // Nesne ismi
						+ "="
						+ (o.key && o.expression ? res[1] : res[2])
						+ "&"
						+ "parent_" + (o.key && o.expression ? res[1] : res[2]) // parent name
						+ "="
						+ (pid ? (o.key && o.expression ? pid[1] : pid[2]) : o.rootID) // root veya anaid
					)
